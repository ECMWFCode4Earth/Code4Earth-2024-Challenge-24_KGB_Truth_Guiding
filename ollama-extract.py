...
examples = "/home/user/large-disk/crawled_resources/technical_memoranda/9507-all-sky-assimilation-microwave-humidity-sounders/texts/output_3.txt"
...
with open(examples, "r", encoding="utf-8") as f:
    ...
    stream = ollama.chat(
        ...
        messages=[
            ...
            {"role": "user", "content": user_promt + text},
        ],
        stream=True,
    )
